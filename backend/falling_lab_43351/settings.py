"""
Django settings for falling_lab_43351 project.
...
ROOT_URLCONF = 'falling_lab_43351.urls'
...
WSGI_APPLICATION = 'falling_lab_43351.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_lab_43351 API",
    "DESCRIPTION": "API documentation for falling_lab_43351 App",
    "VERSION": "v1",
}
